  ...
  return (
    <section id="extensions" className={`mx-auto w-full max-w-7xl px-4 lg:px-6 xl:px-8 ${sectionSpacing}`}>
      <div className={`${isNeo ? "mb-8 text-center" : "mb-6"} w-full min-w-0`}>
        ...
        <h3 className={`mt-3 text-2xl md:text-3xl font-bold leading-tight ${isNeo ? "text-neo-text-primary" : "text-slate-900 dark:text-white"}`}>
      ...
      <div className="grid gap-4 lg:grid-cols-3 2xl:gap-6">
        <div className={`${baseCard} relative`}>
          ...
          <div className="relative flex items-center gap-3 mb-3">
            <div className={`flex h-10 w-10 items-center justify-center rounded-lg ${isNeo ? "bg-neo-primary/15 text-neo-primary" : "bg-emerald-100 dark:bg-emerald-500/15 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-transparent"}`}>
              <Chrome className="h-5 w-5" />
            </div>
            <div>
              <p className={`${isNeo ? "text-neo-text-primary" : "text-slate-900 dark:text-white"} text-sm font-bold`}>Extensión de navegador</p>
              <p className={`${isNeo ? "text-neo-text-secondary" : "text-slate-700 dark:text-slate-400"} text-xs font-medium`}>Chrome / Edge / Brave</p>
            </div>
          </div>
          <ul className={`${isNeo ? "text-neo-text-secondary" : "text-slate-900 dark:text-slate-300"} space-y-2 text-sm font-medium`}>
            <li className="flex items-center gap-2">
              <Check className={`${isNeo ? "text-neo-primary" : "text-emerald-600 dark:text-emerald-400"} h-4 w-4`} />
          ...
          <a
            ...
            className={`mt-4 inline-flex items-center gap-2 text-xs font-bold transition-colors ${isNeo ? "text-neo-primary hover:text-neo-primary-dark" : "text-emerald-700 dark:text-emerald-200 hover:text-emerald-900 dark:hover:text-emerald-100"}`}
          >
        ...
        <div className={`${baseCard} relative`}>
          ...
          <div className="relative flex items-center gap-3 mb-3">
            <div className={`flex h-10 w-10 items-center justify-center rounded-lg ${isNeo ? "bg-neo-primary/15 text-neo-primary" : "bg-indigo-100 dark:bg-indigo-500/15 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-transparent"}`}>
              <VscVscode className="h-5 w-5" />
            </div>
            <div>
              <p className={`${isNeo ? "text-neo-text-primary" : "text-slate-900 dark:text-white"} text-sm font-bold`}>Extensión VS Code</p>
              <p className={`${isNeo ? "text-neo-text-secondary" : "text-slate-700 dark:text-slate-400"} text-xs font-medium`}>Panel lateral y hover info</p>
            </div>
          </div>
          <ul className={`${isNeo ? "text-neo-text-secondary" : "text-slate-900 dark:text-slate-300"} space-y-2 text-sm font-medium`}>
            <li className="flex items-center gap-2">
              <Check className={`${isNeo ? "text-neo-primary" : "text-indigo-600 dark:text-indigo-300"} h-4 w-4`} />
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <a
              ...
              className={`inline-flex items-center gap-2 text-xs font-bold transition-colors ${isNeo ? "text-neo-primary hover:text-neo-primary-dark" : "text-indigo-700 dark:text-indigo-200 hover:text-indigo-900 dark:hover:text-indigo-100"}`}
            >
              <Download className="h-4 w-4" />
              Descargar .vsix
            </a>
        ...
        <div className={`${baseCard} relative`}>
          ...
          <div className="relative flex items-center gap-3 mb-4">
            <div className={`flex h-10 w-10 items-center justify-center rounded-lg ${isNeo ? "bg-neo-surface text-neo-text-primary" : "bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-transparent"}`}>
              <MousePointerClick className="h-5 w-5" />
            </div>
            <div>
              <p className={`${isNeo ? "text-neo-text-primary" : "text-slate-900 dark:text-white"} text-sm font-bold`}>Vista rápida</p>
              <p className={`${isNeo ? "text-neo-text-secondary" : "text-slate-700 dark:text-slate-400"} text-xs font-medium`}>Cómo se ven en acción</p>
            </div>
          </div>
          ...
          <div className={`${isNeo ? "border-neo-border/60 bg-neo-bg text-neo-text-secondary" : "border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-gradient-to-br dark:from-slate-900 dark:via-slate-900 dark:to-slate-950 text-slate-700 dark:text-slate-400"} mt-3 rounded-lg border p-3 text-[11px] font-medium`}>
