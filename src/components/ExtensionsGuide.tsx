      ...
      <div className="rounded-3xl border border-slate-900 dark:border-slate-800 bg-white dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 p-4 sm:p-6 md:p-10 shadow-none dark:shadow-[0_30px_80px_rgba(0,0,0,0.55)] overflow-hidden">
        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
          <div className="space-y-2 w-full min-w-0">
            <span className="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-100 dark:bg-emerald-500/10 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.15em] text-emerald-700 dark:text-emerald-200">
              Guía detallada
            </span>
            <h3 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Cómo instalar y usar las extensiones sin perder contexto</h3>
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-slate-900 dark:border-slate-800 bg-slate-100 dark:bg-slate-900 px-4 py-2 text-xs font-bold text-slate-900 dark:text-slate-300">
        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-2 2xl:gap-6 items-start">
          <article className={`${cardBase} flex flex-col gap-3`}>
            <div className="flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-100 dark:bg-emerald-500/15 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-transparent">
                <Chrome className="h-5 w-5" />
              </span>
              <div>
                <p className="text-sm font-bold text-slate-900 dark:text-white">Extensión de navegador</p>
                <p className="text-xs text-slate-700 dark:text-slate-400 font-medium">Chrome / Edge / Brave</p>
              </div>
            </div>
            ...
            <div className="mt-4 space-y-4">
              <div className="grid gap-3 md:grid-cols-2">
                <div className="flex flex-col gap-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/60 p-3">
                  <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-slate-500 dark:text-slate-400">Instalación</p>
                  <ol className="space-y-2 text-sm leading-relaxed text-slate-900 dark:text-slate-200 list-decimal list-inside break-words font-medium">
                    <li>
                ...
                <div className="flex flex-col gap-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/60 p-3">
                  <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-slate-500 dark:text-slate-400">Uso inmediato</p>
                  <ul className="space-y-2 text-sm leading-relaxed text-slate-900 dark:text-slate-200 break-words font-medium">
                    <li className="flex gap-2">
                      <MousePointerClick className="h-4 w-4 text-emerald-600 dark:text-emerald-300 shrink-0" />
          ...
          <article className={`${cardBase} flex flex-col gap-3`}>
            <div className="flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-100 dark:bg-indigo-500/15 text-indigo-700 dark:text-indigo-200 border border-indigo-200 dark:border-transparent">
                <VscVscode className="h-5 w-5" />
              </span>
              <div>
                <p className="text-sm font-bold text-slate-900 dark:text-white">Extensión VS Code</p>
                <p className="text-xs text-slate-700 dark:text-slate-400 font-medium">Panel lateral y hover info</p>
              </div>
            </div>
            ...
            <div className="mt-4 space-y-4 md:grid md:grid-cols-2 md:gap-4 md:space-y-0">
              <div className="flex flex-col gap-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/60 p-3">
                <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-slate-500 dark:text-slate-400">Instalación</p>
                <ol className="mt-2 space-y-2 text-sm leading-relaxed text-slate-900 dark:text-slate-200 list-decimal list-inside break-words font-medium">
                  <li>
              ...
              <div className="flex flex-col gap-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/60 p-3">
                <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-slate-500 dark:text-slate-400">Uso inmediato</p>
                <ul className="mt-2 space-y-2 text-sm leading-relaxed text-slate-900 dark:text-slate-200 break-words font-medium">
                  <li className="flex gap-2">
                    <PanelRightOpen className="h-4 w-4 text-indigo-600 dark:text-indigo-200 shrink-0" />
                  ...
                  <li className="flex flex-wrap items-start gap-2 leading-relaxed break-words w-full">
                    <PanelRightOpen className="h-4 w-4 text-indigo-600 dark:text-indigo-200 shrink-0 mt-0.5" />
                    <span className="text-sm text-slate-900 dark:text-slate-200 break-words flex-1 min-w-[200px]">
                      Ejecuta el comando{" "}
        ...
        <div className="mt-6 grid gap-3 md:grid-cols-3 2xl:gap-4">
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/60 p-4 flex flex-col gap-2">
            <div className="flex items-center gap-2 text-sm font-semibold text-slate-900 dark:text-white">
              <PanelRightOpen className="h-4 w-4 text-indigo-600 dark:text-indigo-200" />
